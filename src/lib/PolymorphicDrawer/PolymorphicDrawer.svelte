...
<script lang="ts">
    ...
    import { drawerStore, type PolymorphicDrawerComponent } from "./polymorphic-drawer";
    ...
    // *WARNING* Uses skeleton internals may by subject to change
	import { dynamicTransition } from "$lib/internal/transitions";
    // import { focusTrap } from "@skeletonlabs/skeleton/dist/actions/FocusTrap/focusTrap";
	 ...
	 * @type {boolean}
	 */
	export let transitions = true;// !$prefersReducedMotionStore;
...
>
    ...
    >
        <!-- Slot: Default -->
        <svelte:component this={active?.component} {...active?.props}/>
    </div>
</div>
{/if}
